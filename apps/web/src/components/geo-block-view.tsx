...
export function GeoBlockView() {
  return (
    <div className="flex min-h-screen items-center justify-center overflow-auto bg-brand-bg p-3 font-mono text-brand-gray selection:bg-brand-red selection:text-white">
      <div className="terminal-frame flex w-full max-w-[1120px] flex-col overflow-hidden">
        <header className="vim-tabline min-h-[68px] shrink-0 flex-col items-stretch border-b">
          <div className="flex min-h-[34px] items-center justify-between border-b border-brand-border">
            ...
            <div className="flex items-center gap-2 px-3 text-[10px] uppercase text-brand-red">
              <span className="h-1.5 w-1.5 bg-brand-red"></span>
              campaign live
            </div>
          </div>
        ...
        <main className="grid grid-cols-1 items-start gap-3 p-3 lg:grid-cols-[280px_minmax(0,760px)] lg:justify-center">
          <aside className="terminal-pane flex min-h-[420px] flex-col overflow-hidden">
            ...
            <div className="flex flex-1 flex-col justify-between p-4">
              <div>
                <div className="mb-4 text-xs uppercase text-brand-red">// PUBLIC VIEW</div>
              ...
              <div>
                <div className="text-xs font-bold uppercase text-brand-red">BREAK. TRACK. BUILD.</div>
          ...
          <section className="terminal-pane flex w-full max-w-[760px] flex-col overflow-hidden" data-active="true">
            <div className="terminal-pane-title">
              access notice
              <span className="ml-auto text-brand-red">blocked</span>
            </div>
            <div className="p-4 lg:p-5">
              <div className="mb-4 flex items-center gap-2 text-xs uppercase text-brand-red">
              ...
              <div className="mt-5 flex flex-wrap items-center gap-4 border-t border-brand-border pt-4 text-[11px] text-brand-gray">
                ...
                <span><span className="text-brand-red">//</span> comment</span>
                <span><span className="text-brand-red">||</span> pause</span>
        ...
        <footer className="vim-statusline h-9 shrink-0 justify-between border-t">
          <div className="flex min-w-0 items-center">
            ...
            <span className="vim-status-segment text-brand-red">readonly</span>
          </div>
