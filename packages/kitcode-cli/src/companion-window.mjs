...
.metrics{display:grid;grid-template-columns:.9fr 1.1fr .9fr;gap:4px;min-width:0}
...
<body><main id="main"><div class="top"><div class="top-brand"><span class="mark">KITCODE</span><span>MINI</span></div><button class="dashboard-button" id="dashboardButton" data-testid="companion-dashboard" type="button" data-ready="false">Dashboard</button></div><div class="body"><strong class="percent" id="percent">--</strong><span class="state" id="state">CONNECTING</span></div><div class="metrics" aria-label="Next break remaining"><span class="metric"><span class="metric-label">LEFT =</span><strong class="metric-value" id="equalsLeftValue" data-testid="mini-equals-left">--</strong></span><span class="metric"><span class="metric-label">LEFT</span><strong class="metric-value" id="timeLeftValue" data-testid="mini-time-left">--</strong></span><span class="metric"><span class="metric-label">NEXT</span><strong class="metric-value" id="nextValue" data-testid="mini-next-break">--</strong></span></div></main>${renderCompanionSwitcher('mini')}<script>
