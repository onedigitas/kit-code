...
excludes(electronSource, "compact: {", 'Electron should not define the removed compact mode preset');
excludes(electronSource, "progress: {", 'Electron should not define the removed progress mode preset');
excludes(electronSource, "watch: {", 'Electron should not define the removed watch mode preset');
...
excludes(electronSource, "ipcMain.handle('kitcode:set-view-mode'", 'Electron should not expose the removed mode-change handler');
...
excludes(preloadSource, "kitcode:set-view-mode", 'Preload should not expose the removed mode-change IPC channel');
...
excludes(terminalHtml, 'class="view-switcher"', 'Terminal should not expose the removed view mode switcher');
excludes(terminalHtml, 'data-mode=', 'Terminal should not render removed view mode buttons');
excludes(terminalHtml, 'mode-icon', 'Terminal should not render removed view mode icons');
...
excludes(terminalHtml, 'setViewMode', 'Terminal should not call the removed mode bridge');
